...
<aside id="default-sidebar"
    ...
    <div
        ...
        <ul class="space-y-2">
            <div class="flex"> 
                <i class="fi fi-ss-book-open-cover dark:text-yellow-200 text-4xl pl-2 pt-2"></i>
                <h2 class="dark:text-blue-200 font-bold ml-3 flex items-center text-xl">Library <span class="text-yellow-200">XPRO</span> </h2>
            </div>
            
           
            <li>
                <a href="{{ route('dashboard') }}"
                    class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group mt-5">
            ...
            <li>
                <button type="button"
                    class="flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 mt-2"
                ...
                @auth
                    @if (Auth::user()->role === 'admin')
                        <li>
                            <button type="button"
                                    class="flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 mt-3"
        ...
        <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
            ...
            <li>
                <a href="#"
                    class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                    <svg aria-hidden="true"
                        class="flex-shrink-0 w-6 h-6 text-gray-400 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-gray-700"
                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path
            ...
            <form action="{{ route('logout') }}" method="POST">
                ...
                <button type="submit">
                    <span
                        class="ml-3 flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">Keluar</span>
                </button>
            </form>
        </ul>
    </div>
